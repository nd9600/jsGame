...
describe("BoardMovementUp", () => {
    ...
    it("applies_successful_movement_event", () => {
        ...
        let gameState = new GameState(usefulFunctions.makeBoardsObject([new Board(Board.idCounter++, "", boardData, characterPosition, endPoint)]));
...
//# sourceMappingURL=BoardMovementTest.js.map